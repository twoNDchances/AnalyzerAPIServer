...
class ActionDetails(Resource):
    def get(self, id):
        ...
        sqlis = response_elasticsearch.search(index='analyzer-sqlis', query={'term': {'action_id.keyword': id}}, size=ES_MAX_RESULT)
        ...
        xss_related_actions = []
        xsss = response_elasticsearch.search(index='analyzer-xsss', query={'term': {'action_id.keyword': id}}, size=ES_MAX_RESULT)
        ...
        fu_related_actions = []
        fus = response_elasticsearch.search(index='analyzer-fus', query={'term': {'action_id.keyword': id}}, size=ES_MAX_RESULT)
